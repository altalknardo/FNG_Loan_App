...
export function calculateUpfrontCosts(
  ...
  const depositRate = 0.1; // 10% loan deposit (refundable)
...
export function clearStorage() {
  ...
  localStorage.removeItem("companyBalance");
  localStorage.removeItem("contributionBalance");
  localStorage.removeItem("depositOffsetRequests");
  localStorage.removeItem("insuranceBalance");
  localStorage.removeItem("interestTransactions");
  localStorage.removeItem("lastActivityTime");
  localStorage.removeItem("loanDeposits");
  localStorage.removeItem("loanInterestBalance");
  localStorage.removeItem("loanInterest_business");
  localStorage.removeItem("loanInterest_jumbo");
  localStorage.removeItem("loanInterest_sme");
